var MyList = React.createClass({
  ...
  propTypes: {
    strArr: React.PropTypes.arrayOf(React.PropTypes.string),
  ...
  render: function() {
    ...
    return React.DOM.textarea({name:'List', id:'MyList', rows:10, readOnly:'true', value:fnGetStrFromArray(this.props.isSortFlag)});
  },
});
